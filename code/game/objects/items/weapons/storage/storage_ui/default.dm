/datum/storage_ui/default
	...
	var/obj/screen/storage/item/stored_start
	var/obj/screen/storage/item/stored_continue
	var/obj/screen/storage/item/stored_end
	var/obj/screen/close/closer

/datum/storage_ui/default/New(var/storage)
	..()
	boxes = new /obj/screen/storage(  )
	boxes.SetName("storage box")
	...
	stored_start = new /obj/screen/storage/item( ) //we just need these to hold the icon
	stored_start.icon_state = "stored_start"
	stored_start.layer = HUD_UNDER_ITEM_LAYER
	stored_continue = new /obj/screen/storage/item( )
	stored_continue.icon_state = "stored_continue"
	stored_continue.layer = HUD_UNDER_ITEM_LAYER
	stored_end = new /obj/screen/storage/item( )
